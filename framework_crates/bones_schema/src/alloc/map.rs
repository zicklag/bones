...
impl SchemaMap {
    ...
    pub fn try_get_ref(&self, key: SchemaRef) -> Result<Option<SchemaRef<'_>>, SchemaMismatchError> {
...
impl<K: HasSchema, V: HasSchema> SMap<K, V> {
    ...
    pub fn values(
        &self,
    ) -> std::iter::Map<hash_map::Values<'_, SchemaBox, SchemaBox>, for<'a> fn(&'a SchemaBox) -> &'a V>
    {
